    ...
    const handleImageUpload = async(key, file) => {
        ...
        if (key ==="1" && !aiUsed) {
            ...
            reader.onloadend = async () => {
                ...
                try {
                    await toast.promise(
                        axios.post('/api/store/ai', {base64Image : base64String,
                            mimeType}, {headers: {Authorization : `Bearer ${token}`}}),
                            {
                                loading: "Analyzing Image using AI...",
                                success: (res) => {
                                    const data = res.data
                                    ...
                                    return "Ai could not analyze the Imaze"
                                },
    ...
    const onSubmitHandler = async (e) => {
        ...
        try {
            ...
            if(!images[1] && !images[2] && !images[3] && !images[4]){
                return  toast.error('Please Upload atleast 1 image')
            }
            setLoading(true) 
